...
const NewWorld = () => {
    return (
        <main style={pageStyles}>
            ...
            <p>
                初见 Gatsbyjs ，由于以前从未接触过 JavaScript ，开始上手时感到比较困难，但是经过一番努力，至少……它工作起来了。
            </p>

            <p>以下是夏哥哥对其现代话给出的定义[1]：</p>
            <ol style={listStyles}>
            ...
            <p>
              另外，在构建的过程中，推荐参考 <Link to="https://gatsbyjs.com/docs">Gatsby文档</Link> 和 <Link to="https://developer.mozilla.org">MDN</Link> 文档，给 Otto 带来了很多启发。
            ...
            <div>[1]^引用自 <Link to="https://sharzy.in/posts/2021-02-05-gatsby-rebuild/">Sharzy</Link> 的博客</div>
            <footer>
