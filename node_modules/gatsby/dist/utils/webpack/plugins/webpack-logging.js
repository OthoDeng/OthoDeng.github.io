...
class WebpackLoggingPlugin {
  ...
  apply(compiler) {
    ...
    if (webpackBundleAnalyzerPath) {
      compiler.hooks.beforeRun.tapPromise(this.PLUGIN_NAME, () => (specifier => new Promise(r => r(`${specifier}`)).then(s => _interopRequireWildcard(require(s))))(webpackBundleAnalyzerPath).then(({
