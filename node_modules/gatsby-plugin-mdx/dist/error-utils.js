...
const ERROR_MAP = {
  ...
  [ERROR_CODES.NonExistentFileNode]: {
    text: context => `Unable to locate the GraphQL File node for ${context.resourcePath}`,
    level: `ERROR`,
    type: `PLUGIN`
  },
  [ERROR_CODES.InvalidAcornAST]: {
    text: context => `Invalid AST. Parsed source code did not return valid output. File:\n${context.resourcePath}`,
    level: `ERROR`,
    type: `PLUGIN`,
    category: `USER`
  },
