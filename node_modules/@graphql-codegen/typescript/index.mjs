...
import { OperationVariablesToObject, normalizeAvoidOptionals, BaseTypesVisitor, getConfigValue, DeclarationBlock, indent, transformComment, isOneOfInputObjectType, wrapWithSingleQuotes } from '@graphql-codegen/visitor-plugin-common';
